...
window.addEventListener("DOMContentLoaded", function() {
  ...
  if (rtdData.version === latest) {
    document.querySelector("div[data-md-component=announce]").innerHTML = "<div id='announce-msg'>You are viewing the docs for an unreleased version of "+tool_name+", <a href='https://"+documentation_name+".readthedocs.io/en/stable/'>click here to go to the latest stable version.</a></div>"
  ...
  else if (rtdData.version !== stable_version_name) {
    document.querySelector("div[data-md-component=announce]").innerHTML = "<div id='announce-msg'>You are viewing the docs for a previous version of "+tool_name+", <a href='https://"+documentation_name+".readthedocs.io/en/stable/'>click here to go to the latest stable version.</a></div>"
    var bannerHeight = document.getElementById('announce-msg').offsetHeight + margin
    document.querySelector("header.md-header").style.top = bannerHeight +"px";   
    document.querySelector('style').textContent +=
    "@media screen and (min-width: 76.25em){ .md-sidebar { height: 0;  top:"+ (bannerHeight+headerHeight)+"px !important; }}"
